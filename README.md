...
![MKS SERVO42B](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/SERVO42B.png "MKS SERVO42B")
...
### How to Build
  ...
  ![MKS SERVO42B Build](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/AtomBuild.png "MKS SERVO42B Build")
  
  Code editor
  Open platformio.ini file, set default_envs = mks_servo42b
  ![MKS SERVO42B Build](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/CodeBuild.png "MKS SERVO42B Build")
...
### How to upload firmware
  ...
  ![jlink_stlink](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/jlink_stlink.png "jlink_stlink")
#### Use jlink connect MKS SERVO42B
  Use jlink connect MKS SERVO42B
  ![MKS SERVO42B SWD](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/SWDPIN.png "MKS SERVO42B SWD")
  ![MKS SERVO42B SWDPIN](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/MKSSERVO42BSWDPIN.png "MKS SERVO42B SWDPIN")
...
If you are using jlink for the first time, you may need to install the driver Upload firmware by jlink jlink connect PC Because MKS SERVO42B motherboard encrypted by Jflash,we need unsecure chip Usecure chip by Jflah
  ![jlink connect PC](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/jlink.png "jlink connect PC")
  ![Unsecurechip](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/Unsecurechip.png "Unsecurechip")
  ...
  ![uploadsuccess](https://github.com/makerbase-mks/MKS-SERVO42B/Picture/blob/master/uploadsuccess.jpg "uploadsuccess")
